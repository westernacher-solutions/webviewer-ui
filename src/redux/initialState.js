...
export default {
  viewer: {
    ...
    toolButtonObjects: {
      ...
      AnnotationCreateSignature: { type: 'customElement', dataElement: 'signatureToolButton', title: 'annotation.signature', img: 'ic_annotation_signature_black_24px', showColor: 'active', group: 'miscTools' },
